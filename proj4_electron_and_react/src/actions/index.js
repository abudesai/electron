...
export const addVideos = videos => dispatch => {
  // console.log("sending videos to electron to get metadata", videos);
  ipcRenderer.send("videos:added", videos);

  ipcRenderer.on("metadata:complete", (event, videosWithData) => {
    // console.log('Received meta data, now dispatching add videos', videosWithData);
...
export const convertVideos = videos => (dispatch, getState) => {
  console.log("Sending video to electron for format conversion");
